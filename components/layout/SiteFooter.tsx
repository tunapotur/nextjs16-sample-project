        ...
        <div className="grid gap-10 md:grid-cols-8">
          ...
          <div className="space-y-4 md:col-span-4">
            <div className="grid gap-4 sm:grid-cols-3">
              ...
              {/* TODO bunlar silinecek */}
              <div className="space-y-4 md:col-span-3">
                <div className="text-sm text-mycolor2/45">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Illo
                  distinctio molestiae veniam eligendi laboriosam necessitatibus
                  ullam accusantium vero praesentium sequi alias sapiente, nihil
                  culpa totam nostrum tempora nam quam. Iusto?
                </div>
              </div>
